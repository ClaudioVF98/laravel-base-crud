...
class ComicsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        for ($i=0; $i < 10; $i++) {
            $comic = New Comic();
            $comic->title = "Catwoman Vol. 1: Copycats";
            $comic->description = "Following her near-miss wedding with Batman";
            $comic->thumb = "https://www.dccomics.com/sites/default/files/styles/covers192x291/public/gn-covers/2019/04/CTWv1_CC_144-001_HD_5ca5299a751963.53054221.jpg?itok=ooPaoLDq";
            $comic->price = "16.99";
            $comic->series = "Catwoman";
